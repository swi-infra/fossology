...
SELECT
  rf.rf_shortname, rf.rf_licensetype, rf.rf_fullname, rf.rf_text, rc.rf_shortname parent_shortname,
...
WHERE rf.rf_detector_type=$1";
    ...
    ob_start();
    $head = array(
        'shortname', 'licensetype', 'fullname', 'text', 'parent_shortname', 'report_shortname',
